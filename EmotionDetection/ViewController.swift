...
class ViewController: UIViewController {
    ...
    @IBOutlet var angry: UIProgressView!
    @IBOutlet var happy: UIProgressView!
    @IBOutlet var disgust: UIProgressView!
    @IBOutlet var sad: UIProgressView!
    @IBOutlet var fear: UIProgressView!
    @IBOutlet var surprise: UIProgressView!
    ...
    func handleFaces(request: VNRequest, error: Error?) {
        DispatchQueue.main.async {
            ...
            for face in results1 {
                ...
                var haha = c.pixelBuffer(width: 224, height: 224)
                let model = CNNEmotions()
                let input = CNNEmotionsInput(data: haha!)
